...
from handlers import start, feed, name, stats, fight, leaderboard, attack, help, quest, mining, test, bug
...
def setup_handlers():
    ...
    router.message.register(test.add_handler, Command("test"))
    router.message(Command("bug"))(bug.bug_report_handler)
    return router
